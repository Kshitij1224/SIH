      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold text-gray-900">MedX Hospital</span>
            </div>
            <p className="text-gray-600 text-sm">
              Advanced hospital management system for better patient care.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">Admin Links</h3>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6">
          <p className="text-center text-gray-500 text-sm">
            © 2025 MedX Hospital. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
