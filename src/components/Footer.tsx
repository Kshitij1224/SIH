        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="group">
                <a href="#government-schemes" className="flex items-center hover:text-white transition-all duration-300 group-hover:translate-x-1">
                  <span className="opacity-0 group-hover:opacity-100 mr-1 transition-all duration-300">→</span>
                  <span>Government Schemes</span>
                </a>
              </li>
              <li className="group">
                <a href="#ai-chatbot" className="flex items-center hover:text-white transition-all duration-300 group-hover:translate-x-1">
                  <span className="opacity-0 group-hover:opacity-100 mr-1 transition-all duration-300">→</span>
                  <span>AI Chatbot</span>
                </a>
              </li>
              <li className="group">
                <a href="#telemedicine" className="flex items-center hover:text-white transition-all duration-300 group-hover:translate-x-1">
                  <span className="opacity-0 group-hover:opacity-100 mr-1 transition-all duration-300">→</span>
                  <span>Telemedicine</span>
                </a>
              </li>
              <li className="group">
                <a href="#videos" className="flex items-center hover:text-white transition-all duration-300 group-hover:translate-x-1">
                  <span className="opacity-0 group-hover:opacity-100 mr-1 transition-all duration-300">→</span>
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-3 text-gray-400">
              <div className="group flex items-center space-x-3 transition-colors duration-300 hover:text-white">
                ...
                <a href="tel:777888999" className="hover:underline">777-888-999</a>
              </div>
              <div className="group flex items-center space-x-3 transition-colors duration-300 hover:text-white">
